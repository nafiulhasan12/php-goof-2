...
$html .= "<a href='http://" . htmlspecialchars($_SERVER['SERVER_NAME']) . ":" . htmlspecialchars($_SERVER['SERVER_PORT']) . "/vendor/dompdf/dompdf/lib/fonts/" . basename($font) . ".php'>Gotcha hack</a>";
